...
(function (a, b) {
  ...
  function ca(a, c, d, e, f, g) {
    ...
    for (; i < j && (k || !l); i++)
      (l = h[i](c, d, e)),
        typeof l == "string" && (!k || g[l] ? (l = b) : (c.dataTypes.unshift(l), (l = ca(a, c, d, e, l, g))));
  ...
  var z = /\.(.*)$/,
    ...
    K = function (a, b) {
      return (
        (!b[1] || a.nodeName.toLowerCase() === b[1]) && (!b[2] || a.id === b[2]) && (!b[3] || b[3].test(a.className))
      );
    },
    L = function (a) {
      ...
      if (!(a.nodeType === 3 || a.nodeType === 8 || !c || !d || !(h = f._data(a)))) {
        ...
        for (k = 0; k < c.length; k++) {
          (l = E.exec(c[k]) || []),
            ...
            (s = f.event.special[m] || {}),
            (o = f.extend(
              { type: m, origType: l[1], data: e, handler: d, guid: d.guid, selector: g, namespace: n.join(".") },
              p
            )),
        ...
        h.promise(v),
          ...
          d.crossDomain == null &&
            ...
            (d.crossDomain = !(
              ...
              (r[1] == bY[1] &&
                r[2] == bY[2] &&
                (r[3] || (r[1] === "http:" ? 80 : 443)) == (bY[3] || (bY[1] === "http:" ? 80 : 443)))
            ))),
    ...
    f.ajaxPrefilter("json jsonp", function (b, c, d) {
      ...
      if (b.dataTypes[0] === "jsonp" || (b.jsonp !== !1 && (cg.test(b.url) || (e && cg.test(b.data))))) {
        ...
        b.jsonp !== !1 &&
          ((j = j.replace(cg, l)),
          b.url === j &&
            (e && (k = k.replace(cg, l)), b.data === k && (j += (/\?/.test(j) ? "&" : "?") + b.jsonp + "=" + h))),
          (b.url = j),
          (b.data = k),
          (a[h] = function (a) {
            g = [a];
